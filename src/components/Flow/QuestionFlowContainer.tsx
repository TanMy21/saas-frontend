...
import { layoutNodesWithBypasses } from "../../utils/customLayout";
import { getLayoutElements } from "../../utils/dagreLayout";
import {
  ICustomEdge,
  Condition,
  EdgeFormData,
  ...
  const onConnect: OnConnect = (connection) => {
    setEdges((eds) => {
      ...
      if (!exists && sourceNode && targetNode) {
        ...
        const { layoutNodes, layoutEdges } = getLayoutElements(
          nodes,
          updatedEdges,
          "LR"
        );
        setNodes(layoutNodes); // ✅ re-layout nodes
        return layoutEdges;
      }
